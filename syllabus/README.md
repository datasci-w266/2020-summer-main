...
* [Piazza](https://piazza.com/berkeley/summer2020/datasciw266) - we'll use this for Q&A, and this will be the fastest way to reach the course staff. Note that you can post anonymously, and/or make posts visible only to instructors for private questions.
...
* Course website: [GitHub datasci-w266/2020-summer-main](../../../)
* [Piazza](https://piazza.com/berkeley/summer2020/datasciw266) - we'll use this for Q&A, and this will be the fastest way to reach the course staff. Note that you can post anonymously, and/or make posts visible only to instructors for private questions.
...
### Live Session Slides: [[available here](https://drive.google.com/open?id=1hFyYD_PbGsMRM54noXN0UYmKtY-d6qrK)]
...
<tr><!--- Introductions -->
  <td><strong>Week&nbsp;1-2</strong><br>(May&nbsp;4)</td>
  <td>Introduction
...
<tr><!--- Sentiment/Classification -->
  <td><strong>Week&nbsp;3</strong><br>(May&nbsp;18)</td>
...
<tr><!--- Neural language models -->
  <td><strong>Week&nbsp;6</strong><br>(June&nbsp;8)</td>
...
<tr><!--- Week 7 and 8 -->
  ...
  <td><strong>Week&nbsp;9</strong><br>(June&nbsp;29)</td>
  <td>No Async</td>
  <td><ul>
...
<tr><!--- Week 10 -->
  <td><strong>Week&nbsp;10</strong><br>(July&nbsp;6)</td>
  <td>Summarization</td>
  <td><ul>
...
<tr><!--- Entities -->
  <td><strong>Week&nbsp;11</strong><br>(July&nbsp;13)</td>
  <td>Entities</td>
  <td><ul>
...
<tr><!--- Information Retrieval -->
  <td><strong>Week&nbsp;12</strong><br>(July&nbsp;20)</td>
...
<tr><!--- POS Tagging -->
  <td><strong>Week&nbsp;13</strong><br>(July&nbsp;27)</td>
...
<tr><!--- Dependency Parsing -->
  <td><strong>Week&nbsp;13&nbsp;(cntd)</strong><br>(July&nbsp;27)</td>
